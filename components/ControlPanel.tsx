        ...
        <div className="pt-2 border-t border-slate-700/50">
            <div className="flex items-center gap-2 mb-2 group relative">
                ...
                <div className="absolute left-0 bottom-6 w-64 p-3 bg-slate-900 text-slate-200 text-xs rounded shadow-xl border border-slate-700 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
                    Each twin sends a radio signal (at light speed) on every birthday. This visualises the relativistic Doppler effect: when moving apart, messages arrive less frequently (redshift). When approaching, they arrive rapidly (blueshift). The counter shows how many messages have been received so far.
                </div>
            </div>
